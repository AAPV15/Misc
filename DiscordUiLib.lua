...
function ChannelContent:Slider(text, min, max, start, step, callback)
    local SliderFunc = {}
    ...
    return SliderFunc
			...
			function ChannelContent:Dropdown(text, list, defaultText, callback)
				local DropFunc = {}
				local itemcount = 0
				local framesize = 0
				local DropTog = false
				...
				CurrentSelectedText.Text = defaultText or "..."
